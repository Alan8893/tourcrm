...
Revision ID: 39a770e9df1f
Revises: 9888ee04d9db
Create Date: 2026-09-15 17:38:28.480436
...
def upgrade() -> None:
    ...
    sa.CheckConstraint('(event_id IS NULL) <> (occurrence_id IS NULL)', name='ck_attendance_exactly_one_target'),
    ...
    op.create_index('uq_attendance_event_id_person_id', 'attendance', ['event_id', 'person_id'], unique=True, postgresql_where=sa.text('event_id IS NOT NULL'))
    op.create_index('uq_attendance_occurrence_id_person_id', 'attendance', ['occurrence_id', 'person_id'], unique=True, postgresql_where=sa.text('occurrence_id IS NOT NULL'))
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index('uq_attendance_occurrence_id_person_id', table_name='attendance', postgresql_where=sa.text('occurrence_id IS NOT NULL'))
    op.drop_index('uq_attendance_event_id_person_id', table_name='attendance', postgresql_where=sa.text('event_id IS NOT NULL'))
